<html>
  ...
  <head>
    <title> Manager Signup | TTF </title>
  </head>
...
body {
  background-image: url('images/ms.png');
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> TTF </a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Dear Manager, <br>A warm welcome to you on<span class="edit"> TTF </span></h1>
     <br>
     <span class="edit"> <p>Begin your journey by creating your account.</p> </span>
    </div>
    </div>
